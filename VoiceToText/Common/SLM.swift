...
/// A helper class for working with Apple's on-device Small Language Model (Foundation Models framework)
...
class SLMSessionManager {
    ...
    func recoverSession(id: String, keepLastEntries: Int = 1) -> LanguageModelSession? {
        ...
        let newSession = SLM.recoverSession(
            from: oldSession,
